...
class Profile: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        */
        ...
        let loginButton: UIButton = FBSDKLoginButton(frame: CGRectMake(30, 100, 100, 50))
        loginButton.backgroundColor = UIColor.blueColor()
        loginButton.setTitle("Fbook Login", forState: UIControlState.Normal)
        // btn.addTarget(self, action: "buttonAction:", forControlEvents: UIControlEvents.TouchUpInside)
        loginButton.tag = 1
        self.view.addSubview(loginButton)
        
        func buttonAction(sender: UIButton!) {
            var loginButtonsendtag: UIButton = sender
            if loginButtonsendtag.tag == 1 {
                print("Hello")
            }
        }
...
//            userLocation.text = ((snapshot.value["userDesc"] as? String)!)
        })
